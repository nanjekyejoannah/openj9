	...
	UDATA walkFlags)
{
	...
	if (openj9skyway.initialize(env)) {
		...
		openj9skyway.setIncludeJVMTIObjectTagTables(0 == (walkFlags & J9_MU_WALK_SKIP_JVMTI_TAG_TABLES));
#endif
		openj9skyway.setTrackVisibleStackFrameDepth(0 != (walkFlags & J9_MU_WALK_TRACK_VISIBLE_FRAME_DEPTH));
		openj9skyway.setPreindexInterfaceFields(0 != (walkFlags & J9_MU_WALK_PREINDEX_INTERFACE_FIELDS));
		buf = openj9skyway.scanAndBufferReachableObjects(env, NULL);
		openj9skyway.tearDown(env);
	}
	...
	UDATA walkFlags)
{
	...
	if (openj9skyway.initialize(env)) {
		openj9skyway.setPreindexInterfaceFields(0 != (walkFlags & J9_MU_WALK_PREINDEX_INTERFACE_FIELDS));
		buf = openj9skyway.scanAndBufferReachableFromObject(env, objectPtr);
		openj9skyway.tearDown(env);
	}
...
bool
MM_OpenJ9SkyWay::initialize(MM_EnvironmentBase *env)
{
 ...
 */
void
MM_OpenJ9SkyWay::tearDown(MM_EnvironmentBase *env)
{
	if (NULL != _queue) {
 ...
 */
void
MM_OpenJ9SkyWay::doSlot(J9Object **slotPtr, IDATA type, IDATA index, J9Object *sourceObj)
{
 ...
 */
void
MM_OpenJ9SkyWay::doClassSlot(J9Class **slotPtr, IDATA type, IDATA index, J9Object *sourceObj)
{
	if (*slotPtr != NULL) {
 ...
 */
void
MM_OpenJ9SkyWay::doFieldSlot(GC_SlotObject *slotObject, IDATA type, IDATA index, J9Object *sourceObj)
{
 ...
 */
void
MM_OpenJ9SkyWay::pushObject(J9Object *objectPtr)
{
...
MM_OpenJ9SkyWay::buffer_obj(J9Object *objectPtr)
{
	...
	if (objectBuffer) {
		memcpy(objectBuffer, objectPtr, bufSize);
		objectBuffer[bufSize] = (U_8) '\0';
		buf.buffer = objectBuffer[buffer];
    	buf.size = objectBuffer[bufSize];
    	j9mem_free_memory(objectBuffer);
	}
...
J9Object *
MM_OpenJ9SkyWay::scanObject(J9Object *objectPtr)
{
...
void
MM_OpenJ9SkyWay::scanMixedObject(J9Object *objectPtr)
{
 ...
 */
void
MM_OpenJ9SkyWay::scanPointerArrayObject(J9IndexableObject *objectPtr)
{
 ...
 */
void
MM_OpenJ9SkyWay::scanReferenceMixedObject(J9Object *objectPtr)
{
	GC_MixedObjectDeclarationOrderIterator objectIterator(static_cast<J9JavaVM*>(_omrVM->_language_vm), objectPtr, _shouldPreindexInterfaceFields);
 ...
 */
void
MM_OpenJ9SkyWay::scanClass(J9Class *clazz)
{
 ...
 */
void
MM_OpenJ9SkyWay::findOverflowObjects()
{
 ...
 */
void
MM_OpenJ9SkyWay::doSlot(J9Object **slotPtr) {
	doSlot(slotPtr, J9GC_ROOT_TYPE_UNKNOWN, -1, NULL);
}


void
MM_OpenJ9SkyWay::doClassSlot(J9Class** slotPtr)
{
...
void
MM_OpenJ9SkyWay::doClass(J9Class *clazz) {
	doClassSlot(&clazz);
}
 ...
 */
void
MM_OpenJ9SkyWay::doClassLoader(J9ClassLoader *classLoader)
{
 ...
 */
void
MM_OpenJ9SkyWay::doUnfinalizedObject(J9Object *objectPtr, MM_UnfinalizedObjectList *list)
{
...
void
MM_OpenJ9SkyWay::doOwnableSynchronizerObject(J9Object *objectPtr, MM_OwnableSynchronizerObjectList *list)
{
	J9Object *object = objectPtr;
 ...
 */
void
MM_OpenJ9SkyWay::doMonitorReference(J9ObjectMonitor *objectMonitor, GC_HashTableIterator *monitorReferenceIterator)
{
 ...
 */
void
MM_OpenJ9SkyWay::doJNIWeakGlobalReference(J9Object **slotPtr)
{
 ...
 */
void
MM_OpenJ9SkyWay::doRememberedSetSlot(J9Object **slotPtr, GC_RememberedSetSlotIterator *rememberedSetSlotIterator)
{
 ...
 */
void
MM_OpenJ9SkyWay::doStringTableSlot(J9Object **slotPtr, GC_StringTableIterator *stringTableIterator)
{
 ...
 */
void
MM_OpenJ9SkyWay::doVMClassSlot(J9Class **slotPtr, GC_VMClassSlotIterator *vmClassSlotIterator)
{
 ...
 */
void
MM_OpenJ9SkyWay::doStackSlot(J9Object **slotPtr, void *walkState, const void* stackLocation)
{
 ...
 */
void
MM_OpenJ9SkyWay::doJVMTIObjectTagSlot(J9Object **slotPtr, GC_JVMTIObjectTagTableIterator *objectTagTableIterator)
{
 ...
 */
void
MM_OpenJ9SkyWay::doVMThreadSlot(J9Object **slotPtr, GC_VMThreadIterator *vmThreadIterator)
{
	J9Object *slotValue = *slotPtr;
 ...
 */
void
MM_OpenJ9SkyWay::doFinalizableObject(J9Object *objectPtr)
{
	J9Object *object = objectPtr;
 ...
 */
void
MM_OpenJ9SkyWay::doJNIGlobalReferenceSlot(J9Object **slotPtr, GC_JNIGlobalReferenceIterator *jniGlobalReferenceIterator)
{
